        ...
        <div class="row g-4">
          <div class="col-md-3 text-center" data-aos="flip-left">
            <div class="card border-0">
              <img src="../assets/images/long.jpg" class="rounded-circle mx-auto" width="140"
                height="140">
          ...
          <div class="col-md-3 text-center" data-aos="flip-left" data-aos-delay="100">
            <div class="card border-0">
              <img src="../assets/images/hoai.jpg" class="rounded-circle mx-auto" width="140"
                height="140">
          ...
          <div class="col-md-3 text-center" data-aos="flip-left" data-aos-delay="200">
            <div class="card border-0">
              <img src="../assets/images/thuong.jpg" class="rounded-circle mx-auto" width="140"
                height="140">
          ...
          <div class="col-md-3 text-center" data-aos="flip-left" data-aos-delay="300">
            <div class="card border-0">
              <img src="../assets/images/manh.jpg" class="rounded-circle mx-auto" width="140"
                height="140">
