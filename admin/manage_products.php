    ...
    <div class="card shadow-sm mb-4">
      ...
      <div class="card-body">
        <form method="POST" enctype="multipart/form-data" class="row g-3">
          ...
          <div class="col-md-12">
            <textarea name="description" class="form-control" placeholder="Mô tả sản phẩm"><?= $edit_product['description'] ?? '' ?></textarea>
          </div>
          <div class="col-md-12">
            <?php if ($edit_mode): ?>
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
          <tr>
            ...
            <td>
              ...
              <a href="?delete=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Xóa sản phẩm này?')">
