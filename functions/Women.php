...
$categoryMap = [
    'giaycaogot'      => ['id'=>14, 'name'=>'Giầy Cao Gót'],
    'giaythethao'     => ['id'=>15, 'name'=>'Giầy Thể Thao'],
    'giaychaybodibo'   => ['id'=>16, 'name'=>'Giầy Chạy Bộ & Đi Bộ'],
    'giaybupbe'   => ['id'=>17, 'name'=>'Giầy Búp Bê'],
    'balo'      => ['id'=>5, 'name'=>'Balo'],
    'tuixachvi'   => ['id'=>18, 'name'=>'Túi Xách & Ví']
];
